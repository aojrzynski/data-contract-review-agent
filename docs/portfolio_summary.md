...
I would add richer sample domains, row-level evidence exports for selected validators, HTML report output, explicit contract diff/apply workflows with human approval gates, and more contract rule types.
